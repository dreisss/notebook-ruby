...
class AboutSymbols < Neo::Koan # rubocop:disable Style/Documentation
  ...
  def test_identical_symbols_are_a_single_internal_object
    ...
    assert_equal true, symbol1 == symbol2
    assert_equal true, symbol1.object_id.equal?(symbol2.object_id)
  end

  def test_method_names_become_symbols
    symbols_as_strings = Symbol.all_symbols.map { |x| x.to_s } # rubocop:disable Style/SymbolProc
  ...
  in_ruby_version('mri') do
    RubyConstant = 'What is the sound of one hand clapping?' # rubocop:disable Lint/ConstantDefinitionInBlock
