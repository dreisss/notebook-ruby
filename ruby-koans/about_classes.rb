...
class AboutClasses < Neo::Koan # rubocop:disable Style/Documentation
  class Dog
  end
  ...
  class Dog2 # rubocop:disable Style/Documentation
  ...
  class Dog3 # rubocop:disable Style/Documentation
    def set_name(a_name) # rubocop:disable Naming/AccessorMethodName
      @name = a_name
    end
  ...
  class Dog4 # rubocop:disable Style/Documentation
    attr_reader :name
  ...
  class Dog5 # rubocop:disable Style/Documentation
    attr_accessor :name
  end
  ...
  class Dog6 # rubocop:disable Style/Documentation
    attr_reader :name
  ...
  class Dog7 # rubocop:disable Style/Documentation
    attr_reader :name
