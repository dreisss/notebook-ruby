...
class AboutToStr < Neo::Koan # rubocop:disable Style/Documentation
  class CanNotBeTreatedAsString # rubocop:disable Style/Documentation
    def to_s
      'non-string-like'
    end
  end
  ...
  class CanBeTreatedAsString # rubocop:disable Style/Documentation
    def to_s
      'string-like'
    end
