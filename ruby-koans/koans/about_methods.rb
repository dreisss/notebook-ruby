...
def my_global_method(a, b) # rubocop:disable Naming/MethodParameterName
  a + b
end

class AboutMethods < Neo::Koan # rubocop:disable Style/Documentation
  ...
  # NOTE: wrong number of arguments is not a SYNTAX error, but a ---> Actually today we use Argument Error
  # runtime error.
  def test_calling_global_methods_with_wrong_number_of_arguments
    exception = assert_raise(ArgumentError) do
      my_global_method
    end
    assert_match(/number of arguments/, exception.message)
  ...
  def method_with_defaults(a, b = :default_value) # rubocop:disable Naming/MethodParameterName
    [a, b]
  end
  ...
  def my_method_in_the_same_class(a, b) # rubocop:disable Naming/MethodParameterName
    a * b
  end
