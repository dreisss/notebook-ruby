...
class AboutMessagePassing < Neo::Koan # rubocop:disable Style/Documentation
  class MessageCatcher # rubocop:disable Style/Documentation
    def caught?
      true
    end
  end
  ...
  def test_methods_can_be_invoked_more_dynamically
    ...
    assert mc.send('caught?')
    assert mc.send('caught' + '?') # rubocop:disable Style/StringConcatenation
  ...
  class AllMessageCatcher # rubocop:disable Style/Documentation
    def method_missing(method_name, *args, &_block) # rubocop:disable Style/MissingRespondToMissing
  ...
  class WellBehavedFooCatcher # rubocop:disable Style/Documentation
