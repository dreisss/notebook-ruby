...
class AboutBlocks < Neo::Koan # rubocop:disable Style/Documentation
  def method_with_block
    result = yield # rubocop:disable Style/RedundantAssignment
    result
  end
  ...
  def test_blocks_can_be_defined_with_do_end_too
    yielded_result = method_with_block do 1 + 2 end # rubocop:disable Style/BlockDelimiters
    assert_equal 3, yielded_result
  end
  ...
  def test_blocks_can_be_assigned_to_variables_and_called_explicitly
    add_one = lambda { |n| n + 1 } # rubocop:disable Style/Lambda
