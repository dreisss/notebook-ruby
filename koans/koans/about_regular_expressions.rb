...
class AboutRegularExpressions < Neo::Koan # rubocop:disable Style/Documentation
  ...
  def test_parentheses_also_capture_matched_content_by_number
    ...
    assert_equal nil, 'James'[/(\w+), (\w+)/, 2]
  end

  def test_variables_can_also_be_used_to_access_captures
    assert_equal 'Gray, James', 'Name:  Gray, James'[/(\w+), (\w+)/]
    assert_equal 'Gray', $1 # rubocop:disable Style/PerlBackrefs
