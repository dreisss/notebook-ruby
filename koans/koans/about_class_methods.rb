...
class AboutClassMethods < Neo::Koan # rubocop:disable Style/Documentation
  class Dog
  end
  ...
  class Dog # rubocop:disable Style/Documentation
    def Dog.a_class_method # rubocop:disable Style/ClassMethods
      :dogs_class_method
    end
  end
  ...
  LastExpressionInClassStatement = class Dog # rubocop:disable Naming/ConstantName, Style/Documentation
                                     21
                                   end
